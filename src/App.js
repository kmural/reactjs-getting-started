...
const GameButton = (props) => {
    ...
    switch (props.answerIsCorrect) {
        case true:
            gameButton = (<Button bsStyle="success" bsSize="large" onClick={props.acceptAnswer}>{checkIcon}</Button>);
            break;
        case false:
            gameButton = (<Button bsStyle="danger" bsSize="large">{timesIcon}</Button>);
            break;
        default:
            gameButton = (
                <Button
